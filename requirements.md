...
Describe your chosen problem and state whether you have access to relevant data. If you get stuck, [see this list of curated datasets](https://git.generalassemb.ly/chris2ds/datasets).
...
1. Problem Statement (what do you plan to work on)     
   - Determine which US women owned business receipent receives the largest government contract award in FY2017 and from which agency.
2. Potential Audience (who may use your result)  
   - Any companies competing for government funding 
3. Goals (what may come out of your work)  
   - Learn to manipulate large data set to find interesting patterns 
4. Success Metrics ( How do we know it works/improves)  
   - Compare results against the values generated by spending explorer in usaspending.gov 
5. Data Source(s):source, format, and necessary action items to obtain or access them 
   - Data is downloaded from usaspending.gov, csv, need to select a subset to play with 
6. Risks (mention any uncertainty that may be a challenge for your to complete your project) 
   - Large set of data (>60MB); missing data;
